...
download.file("http://www.openintro.net/stat/data/ames.RData", destfile = "ames.RData")
load("ames.RData")
```
...
6.  Each group of students in your class should have gotten a slightly different 
...
in handy here (If you are unfamiliar with loops, review the [Sampling Distribution Lab](https://htmlpreview.github.io/?https://github.com/yannlamontagne/oiLabs-base-R/blob/dawson_fall_2016/sampling_distributions/sampling_distributions.html)).
...
7. Using the following function (which was downloaded with the data set), 
