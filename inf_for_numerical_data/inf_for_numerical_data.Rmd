...
7. Manually repeat the hypothesis test and confidence interval by using the t-distribution and use the Welch–Satterthwaite equation to determine the degree of freedom. Show your work!  How does it change the results of the hypothesis test and confidence interval obtained using the inference function? Justify.
